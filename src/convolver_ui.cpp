...
void ConvolverUi::get_irs_info() {
  ...
  */
  ...
  try {
    boost::math::cubic_b_spline<double> spline_L(left_mag.begin(), left_mag.end(), 0.0f, dt);

    boost::math::cubic_b_spline<double> spline_R(right_mag.begin(), right_mag.end(), 0.0f, dt);
...
void ConvolverUi::get_irs_spectrum(const int& rate) {
  ...
  */
  ...
  try {
    ...
    boost::math::cubic_b_spline<double> spline_L(left_spectrum.begin(), left_spectrum.end(), 0.0f, dF);

    boost::math::cubic_b_spline<double> spline_R(right_spectrum.begin(), right_spectrum.end(), 0.0f, dF);
